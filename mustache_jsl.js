...
(function defineMustache(global, factory) {
    ...
    */
    ...
    function escapeRegExp(string) {
        // this is messing up the new jslint so skipping for now
    ...
    */
    function squashTokens(tokens) {
        var squashedTokens = [], token, lastToken, i, numTokens;
    ...
    */
    function parseTemplate(template, tags) {
        ...
        var start, type, value, chr, token, openSection, i, valueLength;
        while (!scanner.eos()) {
            start = scanner.pos;
    ...
    */
    Writer.prototype.parse = function parse(template, tags) {
        ...
        if (tokens == null) {
            cache[template] = parseTemplate(template, tags);
    ...
    */
    Writer.prototype.render = function render(template, view, partials) {
        var tokens = this.parse(template), context;
    ...
    */
    Writer.prototype.renderTokens = function renderTokens(tokens, context, partials, originalTemplate) {
        ...
        var token, symbol, value, i, numTokens;
        numTokens = tokens.length;
        for (i = 0; i < numTokens; i = i + 1) {
            value = undefined;
            token = tokens[i];
